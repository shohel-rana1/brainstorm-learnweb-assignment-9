...
const Footer = () => {
    return (
        <div className="bgColor px-5">
            <div className="d-flex pt-5 px-5 justify-content-between">
            ...
            <div className="px-5 mx-auto">
                <p><i className="far fa-copyright"></i>&nbsp;2021 Brainstorm Learnweb, LLC. All rights reserved.</p>
            </div>
        </div>
    );
};
